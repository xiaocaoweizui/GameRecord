...
var entity=require("../modules/record.js");
...
//http://localhost:3000/record/getTotalCountByDate
router.get('/getTotalCountByDate', function(req, res, next) {
  entity.getTotalCountByDate(req, res, next);
});

//http://localhost:3000/record/query?date=2023-02-01
...
//http://localhost:3000/record/search?startDate=2021-05-01&endDate=2023-09-04
